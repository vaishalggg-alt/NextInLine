...
export default function TeacherView({ teacherEmail }: { teacherEmail: string }) {
  ...
  if (view === 'classes') return (
    <main className="min-h-screen bg-black text-white p-10 flex flex-col items-center">
      <div className="w-full max-w-md flex justify-end">
        <button onClick={signOut} className="text-zinc-600 hover:text-white text-xs tracking-widest uppercase transition-colors">Sign out</button>
      </div>
      <h1 style={{ fontFamily: "'Cormorant Garamond', serif" }} className="text-6xl font-light tracking-widest mb-2">NextInLine</h1>
      <p className="text-zinc-500 text-xs tracking-widest uppercase mb-1">Teacher Dashboard</p>
      <p className="text-zinc-700 text-xs tracking-widest mb-14">{teacherEmail}</p>
